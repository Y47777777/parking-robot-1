...
void* send_func(void *param)
{
   ...
   int times = 1;//thread_arg->sndTimes;  //  26000-12h
...
int testset_motor_speed(int slaveID, float data_speed)
{
    snd_thread_arg_t *thread_arg ;
   CAN_DataFrame *send = new CAN_DataFrame[1];
...
CAN_ChannelSend(dwDeviceHandle, ch, send, 1);

return 0;
}

int Minipcie_CAN_initial(void)//Minipcie-CAN卡初始化程序
{
////////////////////////////////////////////////////////////////////////////////////////////////////////
   // 输入参数处理
   ///////////////////////////////////////////////////////////////////////////////////////////////////////
